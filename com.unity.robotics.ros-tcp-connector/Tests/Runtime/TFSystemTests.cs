...
namespace UnitTests
{
    public class TFSystemTests
    {
        ...
        HeaderMsg MakeHeaderMsg(TimeMsg time, string frameID, int rosVersion)
        {
            if (rosVersion != 2)
            {
        ...
        TimeMsg MakeTimeMsg(int secs, int nsecs, int rosVersion)
        {
            if (rosVersion != 2)
            {
        ...
        [Test]
        public void ReceiveTF_SingleMessage_ReturnsSameTranslationROS1()
        {
            ROSConnection ros = ROSConnection.GetOrCreateInstance();
            ros.UpdateROSVersion(ROSConnection.ROSVersion.ROS1);
        ...
        [Test]
        public void ReceiveTF_FrameWithParent_ReturnsSameTranslationROS1()
        {
            ROSConnection ros = ROSConnection.GetOrCreateInstance();
            ros.UpdateROSVersion(ROSConnection.ROSVersion.ROS1);
            ros.ConnectOnStart = false;
        ...
        [Test]
        public void GetOrCreateFrame_Hierarchy_BuildsValidHierarchyROS1()
        {
            ROSConnection ros = ROSConnection.GetOrCreateInstance();
            ros.UpdateROSVersion(ROSConnection.ROSVersion.ROS1);
            ros.ConnectOnStart = false;
        ...
        [Test]
        public void ReceiveTF_MultipleMessages_InterpolatesTimesROS1()
        {
            ROSConnection ros = ROSConnection.GetOrCreateInstance();
            ros.UpdateROSVersion(ROSConnection.ROSVersion.ROS1);
            ros.ConnectOnStart = false;
            ...
            int time1_secs = 1000;
            int time2_secs = 2000;
            TimeMsg time1 = MakeTimeMsg(time1_secs, 0, 1);
            Vector3 unityPosition1 = new Vector3(1, 2, 3);
            topic.ReceiveTF(new TFMessageMsg(new TransformStampedMsg[] { new TransformStampedMsg(
                MakeHeaderMsg( time1, parent_frame_id, 1 ),
                simple_frame_id,
                new TransformMsg( unityPosition1.To<FLU>(), new QuaternionMsg()
            ))}));
            TimeMsg time2 = MakeTimeMsg(time2_secs, 0, 1);
            Vector3 unityPosition2 = new Vector3(2, 3, 4);
            topic.ReceiveTF(new TFMessageMsg(new TransformStampedMsg[] { new TransformStampedMsg(
                MakeHeaderMsg( time2, parent_frame_id, 1 ),
                simple_frame_id,
        ...
        [Test]
        public void ReceiveTF_MultipleMessagesOutOfOrder_InterpolatesTimesROS1()
        {
            ROSConnection ros = ROSConnection.GetOrCreateInstance();
            ros.UpdateROSVersion(ROSConnection.ROSVersion.ROS1);
            ros.ConnectOnStart = false;
            ...
            TimeMsg time1 = MakeTimeMsg(time1_secs, 0, 1);
            TimeMsg time2 = MakeTimeMsg(time2_secs, 0, 1);
            TimeMsg time3 = MakeTimeMsg(time3_secs, 0, 1);
            ...
            topic.ReceiveTF(new TFMessageMsg(new TransformStampedMsg[] { new TransformStampedMsg(
                MakeHeaderMsg( time3, parent_frame_id, 1 ),
                simple_frame_id,
        ...
        [Test]
        public void ReceiveTF_SingleMessage_ReturnsSameTranslationROS2()
        {
            ROSConnection ros = ROSConnection.GetOrCreateInstance();
            ros.UpdateROSVersion(ROSConnection.ROSVersion.ROS2);
            ros.ConnectOnStart = false;
            TFSystem system = TFSystem.GetOrCreateInstance();
            TFSystem.TFTopicState topic = system.GetOrCreateTFTopic();
            TFStream stream = system.GetOrCreateFrame(simple_frame_id);
            TimeMsg time = MakeTimeMsg(4567, 890, 2);
            Vector3 unityPosition = new Vector3(1, 2, 3);
            topic.ReceiveTF(new TFMessageMsg(new TransformStampedMsg[] { new TransformStampedMsg(
                MakeHeaderMsg( time, parent_frame_id, 2 ),
                simple_frame_id,
                new TransformMsg( unityPosition.To<FLU>(), new QuaternionMsg()
            ))}));
        ...
        [Test]
        public void ReceiveTF_FrameWithParent_ReturnsSameTranslationROS2()
        {
            ROSConnection ros = ROSConnection.GetOrCreateInstance();
            ros.UpdateROSVersion(ROSConnection.ROSVersion.ROS2);
            ros.ConnectOnStart = false;
        ...
        [Test]
        public void GetOrCreateFrame_Hierarchy_BuildsValidHierarchyROS2()
        {
            ROSConnection ros = ROSConnection.GetOrCreateInstance();
            ros.UpdateROSVersion(ROSConnection.ROSVersion.ROS2);
            ros.ConnectOnStart = false;
        ...
        [Test]
        public void ReceiveTF_MultipleMessages_InterpolatesTimesROS2()
        {
            ROSConnection ros = ROSConnection.GetOrCreateInstance();
            ros.UpdateROSVersion(ROSConnection.ROSVersion.ROS2);
            ros.ConnectOnStart = false;
            ...
            int time1_secs = 1000;
            int time2_secs = 2000;
            TimeMsg time1 = MakeTimeMsg(time1_secs, 0, 2);
            Vector3 unityPosition1 = new Vector3(1, 2, 3);
            topic.ReceiveTF(new TFMessageMsg(new TransformStampedMsg[] { new TransformStampedMsg(
                MakeHeaderMsg( time1, parent_frame_id, 2 ),
                simple_frame_id,
                new TransformMsg( unityPosition1.To<FLU>(), new QuaternionMsg()
            ))}));
            TimeMsg time2 = MakeTimeMsg(time2_secs, 0, 2);
            Vector3 unityPosition2 = new Vector3(2, 3, 4);
            topic.ReceiveTF(new TFMessageMsg(new TransformStampedMsg[] { new TransformStampedMsg(
                MakeHeaderMsg( time2, parent_frame_id, 2 ),
                simple_frame_id,
                new TransformMsg( unityPosition2.To<FLU>(), new QuaternionMsg()
            ))}));
        ...
        [Test]
        public void ReceiveTF_MultipleMessagesOutOfOrder_InterpolatesTimesROS2()
        {
            ROSConnection ros = ROSConnection.GetOrCreateInstance();
            ros.UpdateROSVersion(ROSConnection.ROSVersion.ROS2);
            ros.ConnectOnStart = false;
            ...
            TimeMsg time1 = MakeTimeMsg(time1_secs, 0, 2);
            TimeMsg time2 = MakeTimeMsg(time2_secs, 0, 2);
            TimeMsg time3 = MakeTimeMsg(time3_secs, 0, 2);
            Vector3 unityPosition1 = new Vector3(1, 1, 1);
            Vector3 unityPosition2 = new Vector3(3, 1, 1);
            Vector3 unityPosition3 = new Vector3(3, 3, 1);
            topic.ReceiveTF(new TFMessageMsg(new TransformStampedMsg[] { new TransformStampedMsg(
            ...
            topic.ReceiveTF(new TFMessageMsg(new TransformStampedMsg[] { new TransformStampedMsg(
                MakeHeaderMsg( time3, parent_frame_id, 2 ),
                simple_frame_id,
                new TransformMsg( unityPosition3.To<FLU>(), new QuaternionMsg()
            ))}));
            topic.ReceiveTF(new TFMessageMsg(new TransformStampedMsg[] { new TransformStampedMsg(
